...
<div class="column sixcol">
	...
	<form action="" method="POST" class="site-form">
		...
		<table class="profile-fields">
			<tbody>
				<tr>
					<th style="padding-left:4px;"><?php _e('Notifications', 'makery'); ?></th>
					<td>
				...
				<tr>
					<th style="padding-left:4px;"><?php _e('Email Address', 'makery'); ?></th>
					<td>
				...
				<tr>
					<th style="padding-left:4px;"><?php _e('New Password', 'makery'); ?></th>
					<td>
						<div class="field-wrap">
				...
				<tr>
					<th style="padding-left:4px;"><?php _e('Confirm Password', 'makery'); ?></th>
					<td>
						<div class="field-wrap">
				...
				<tr>
					<th style="padding-left:4px;"><?php _e('Current Password', 'makery'); ?></th>
					<td>
						<div class="field-wrap">
