<aside class="column threecol" style="padding-left:20px;padding-top:45px">
	...
	<div class="profile-preview sidebar-widget">
		<div class="profile-image">
			...
			<div class="profile-upload">
				<form action="" enctype="multipart/form-data" method="POST">
					<label for="shop_thumb" class="element-button " title="<?php _e('Upload Image', 'makery'); ?>">
						<span class="fa fa-upload"></span>
					</label>
			...
			<div class="profile-upload">
				<form action="" enctype="multipart/form-data" method="POST">
					<label for="user_avatar" class="element-button " title="<?php _e('Upload Image', 'makery'); ?>">
						<span class="fa fa-upload"></span>
					</label>
