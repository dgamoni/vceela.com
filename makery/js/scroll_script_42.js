...
$j(document).on("click", "#vertical-menu h3", function ($) {
    //slide up all the link lists
    $j("#vertical-menu ul ul").slideUp();
    $j(".plus",this).html("+");
...
$j(document).on("click", "#vertical-menu-2 h3", function ($) {
    //slide up all the link lists
    $j("#vertical-menu-2 ul ul").slideUp();
    $j(".plus",this).html("+");
    //slide down the link list below the h3 clicked - only if its closed
    if (!$j(this).next().is(":visible")) {
        $j(this).next().slideDown();
