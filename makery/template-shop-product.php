...
<div class="column sixcol">
	...
	<?php } ?>
		...
		<table class="profile-fields">
			<tbody>
				<tr>
					<th style="padding-left:3px;"><?php _e('Name', 'makery'); ?></th>
					<td>
				...
				<tr>
					<th style="padding-left:3px;"><?php _e('Images', 'makery'); ?></th>
					<td>
						<div class="element-gallery">
							<label for="product_image" class="element-button secondary small " title="<?php _e('Add Image', 'makery'); ?>" ><span class="fa fa-plus"></span></label>
							<?php foreach(ThemexWoo::$data['product']['images'] as $image) { ?>
				...
				<tr>
					<th style="padding-left:3px;"><?php _e('Type', 'makery'); ?></th>
					<td>
				...
				<tr>
					<th style="padding-left:3px;"><?php _e('Category', 'makery'); ?></th>
					<td>
						<div class="element-select">
							<span></span>
							<?php 
				...
				<tr>
					<th style="padding-left:3px;"><?php _e('Tags', 'makery'); ?></th>
					<td>
						<div class="field-wrap">
				...
				<tr>
					<th style="padding-left:3px;"><?php _e('Regular Price', 'makery'); ?></th>
					<td>
						<div class="field-wrap">
				...
				<tr>
					<th style="padding-left:3px;"><?php _e('Sale Price', 'makery'); ?></th>
					<td>
						<div class="field-wrap">
				...
				<tr class="trigger-type-physical">
					<th style="padding-left:3px;"><?php _e('Shipping Class', 'makery'); ?></th>
					<td>
						<div class="element-select">
							<span></span>
							<?php 
				...
				<tr class="trigger-type-physical">
					<th style="padding-left:3px;"><?php _e('Stock', 'makery'); ?></th>
					<td>
						<div class="field-wrap">
							<input type="text" name="stock" value="<?php echo esc_attr(ThemexWoo::$data['product']['stock']); ?>" />
						</div>
					</td>
				</tr>
				<?php } ?>
				...
				<tr class="trigger-type-virtual">
					<th style="padding-left:3px;"><?php _e('File', 'makery'); ?></th>
					<td>
						<div class="element-gallery">
							<span class="left"><?php echo ThemexWoo::$data['product']['file']; ?></span>
							<label for="product_file" class="element-button secondary small "  title="<?php _e('Upload File', 'makery'); ?>"><span class="fa fa-upload"></span></label>
				...
				if(!ThemexCore::checkOption('product_attributes')) {
					...
					?>
					<tr>
						<th style="padding-left:3px;"><?php echo $attribute['label']; ?></th>
						<td>
				...
				if(!ThemexCore::checkOption('product_variations') && in_array(ThemexCore::getOption('product_type', 'all'), array('all', 'physical'))) {
					...
					?>
					<tr class="trigger-type-physical">
						<th style="padding-left:3px;"><?php _e('Attributes', 'makery'); ?></th>
						<td>
							<div class="element-options" id="attribute">
								...
								<div class="option">
									...
									<a href="#<?php echo $index; ?>" class="element-remove" title="<?php _e('Remove Attribute', 'makery'); ?>" style=" display:block;  text-align:center;"><span class="fa fa-times"></span></a>
								</div>
								<?php } ?>
								<a href="#add" class="element-button element-clone secondary small " title="<?php _e('Add Attribute', 'makery'); ?>" style=" display:block;"  ><span class="fa fa-plus"></span></a>
							</div>
						</td>
					</tr>
					...
					?>
					<tr class="trigger-type-physical">
						<th style="padding-left:3px;"><?php _e('Variations', 'makery'); ?></th>
						<td>
							<div class="element-options" id="variation">
								...
								<div class="option">
									...
									<a href="#<?php echo $variation->ID; ?>" class="element-remove" title="<?php _e('Remove Variation', 'makery'); ?>"><span class="fa fa-times"></span></a>
								</div>
								<?php } ?>
								<a href="#add" class="element-button element-clone secondary small " title="<?php _e('Add Variation', 'makery'); ?>" ><span class="fa fa-plus"></span></a>
							</div>
						</td>
					</tr>
						...
						<td colspan="2">
							<div class="option-wrap clearfix">
								...
								<div class="fourcol column">
									<div class="field-wrap">
										<input type="text" name="variation_stocks[]" value="" placeholder="<?php _e('Stock', 'makery'); ?>" />
									</div>
								</div>
								<div class="fourcol column">
									<div class="field-wrap">
					...
					<tr class="option-variation-<?php echo $variation->ID; ?> hidden">
						<td colspan="2">
							<div class="option-wrap clearfix">
								...
								<div class="fourcol column">
									<div class="field-wrap">
										<input type="text" name="variation_stocks[]" value="<?php echo intval($variation->_stock); ?>" placeholder="<?php _e('Stock', 'makery'); ?>" />
									</div>
								</div>
								<div class="fourcol column">
									<div class="field-wrap">
		...
		<?php } else { ?>
		<a href="#" class="element-button element-submit primary"><?php _e('Save Changes', 'makery'); ?></a>		
		<a href="<?php echo get_permalink(ThemexWoo::$data['product']['ID']); ?>" target="_blank" title="<?php _e('View', 'makery'); ?>" class="element-button facebook ">
			<span class="fa fa-eye"></span> &nbsp;&nbsp; View
		</a>
		<a href="#product_form" title="<?php _e('Remove', 'makery'); ?>" class="element-button element-colorbox" style="background-color:#e74c3c;">
