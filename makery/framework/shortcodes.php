...
function themex_shops($atts, $content=null) {
	...
	$out='<div class="container shops-wrap clearfix">';
	while($query->have_posts()){
		...
		$out.='<div class="shop-preview-column '.$width.'col '.$class.'">';
		ob_start();
	...
	//$out.='<a href="http://www.vceela.com/shops/" style="color:orange;margin-left:560px">VIEW ALL<img src="http://www.vceela.com/wp-content/uploads/2016/05/arrow_1-2.png"></a>';
